...
import com.example.piperchat.Adapter.MessageAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MessageActivity.this,AfterLogin.class);
                startActivity(intent);
                finish();
            }
        });

        EmojiPopup popup = EmojiPopup.Builder.fromRootView(findViewById(R.id.below)).build(text_send);
